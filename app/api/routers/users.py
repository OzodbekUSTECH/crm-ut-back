...
from app.utils.dependency import get_users_services, get_current_user, UOWDep, users_servicess
...
async def login_in(
    ...
    """
    return await users_servicess.authenticate_user(form_data.username, form_data.password)
